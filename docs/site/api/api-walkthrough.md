...
what happened **since Sharko started**: the feed lives in memory and empties on
a pod restart (the same records also go to stdout for your log pipeline — see
[Audit Log Retention Model](../operator/audit-log.md)).
