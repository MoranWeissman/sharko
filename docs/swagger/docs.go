        ...
        "/init/status": {
            "get": {
                ...
                "responses": {
                    ...
                    "502": {
                        "description": "No active Git connection. A missing or broken ArgoCD connection does NOT 502 here — it surfaces as state \\\"unknown\\\" in a 200 response, since the Git-side probe can still run.",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
