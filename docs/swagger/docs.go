...
const docTemplate = `{
    ...
    "definitions": {
        ...
        "github_com_MoranWeissman_sharko_internal_models.ClusterAssignmentAddonSettings": {
            "type": "object",
            "properties": {
                "createNamespace": {
        ...
        "github_com_MoranWeissman_sharko_internal_orchestrator.EnableAddonV4Request": {
            ...
            "properties": {
                ...
                "settings": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/github_com_MoranWeissman_sharko_internal_models.ClusterAssignmentAddonSettings"
                        }
                    ]
                },
                "values": {
