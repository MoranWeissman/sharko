...
var HandlerTier = map[string]audit.Tier{
	...
	// V2-cleanup-89.6; managed_cluster_self_heal, V3 G3; addon_values_engine_enabled,
	// gitops-proud P4-I D2) — a ConfigMap write, not a Git-affecting mutation;
	...
	"handleSetAddonValuesEngineEnabled": audit.Tier1,
