...
func (o *Orchestrator) EnableAddon(ctx context.Context, req EnableAddonRequest) (*EnableAddonResult, error) {
	...
	// at the bottom of the global values file. This only fires on initial
	// enable (the addon's stanza is added with the template fields
	// uncommented). If the cluster already has a stanza for this addon
	// with non-enabled fields, we leave it alone.
