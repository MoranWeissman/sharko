...
// sharko-engine.yaml to ArgoCD. Only the first-run init flow does
...
//  4. THEN apply sharko-engine.yaml to ArgoCD, which brings up the
...
type RuntimeHandoffReport struct {
	...
	// EngineApplied reports whether sharko-engine.yaml has been
	// handed to ArgoCD.
...
// retire the old ApplicationSets, then hand sharko-engine.yaml to
// ArgoCD.
