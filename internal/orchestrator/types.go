...
type GitOpsConfig struct {
	...
	// engine pin (sharko-engine.yaml, design doc §2.5) names as the
	...
	// DefaultEngineChartRepoURL (BuildV4SeedFiles applies the default, so
	// existing callers that never set this field still get a working pin).
	EngineChartRepoURL string
}
