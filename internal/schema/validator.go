// V125-1-9 Story 9.4 — read-time JSON Schema validator.
//
// This file wires the schemas generated by Story 9.3 into a runtime
// validator that the envelope-aware reader paths landed in Stories 9.1 +
// 9.2 call before returning their parsed structs. The flow:
//
...
//	 the V125-1-9 back-compat
//	 contract is that pre-
//	 envelope files keep
//	 working as-is)
//
