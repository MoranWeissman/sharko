...
func NewValidator() (*Validator, error) {
	v := &Validator{schemas: make(map[string]*jsonschema.Schema, 2)}
...
// https://sharko.io/schemas/addon-catalog.v1.json failed to compile" —
...
func knownKinds(v *Validator) string {
	...
	var known []string
	for _, k := range []string{KindManagedClusters, KindAddonCatalog} {
