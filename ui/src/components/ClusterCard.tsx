...
export function ClusterCard({
  ...
  return (
    <div
      ...
      role="button"
      tabIndex={0}
      className="group cursor-pointer rounded-xl border border-[#90c8ee] bg-[#e0f0ff] p-4 shadow-sm transition-all duration-150 hover:-translate-y-0.5 hover:border-teal-400 hover:shadow-md dark:border-gray-700 dark:bg-gray-800 dark:hover:border-teal-500"
    >
