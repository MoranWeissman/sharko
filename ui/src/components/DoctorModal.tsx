/**
 * DoctorModal — connection doctor (V2-cleanup-88.4 / 88.5). Mirrors
 * DiagnoseModal's shape (fetch-on-open, loading/error/result states) but
 * renders the doctor's four real-attempt checks instead of IAM policy
 * simulation: connection credentials, addon secret paths, cross-account
 * role assumption, and cluster access. Each check is pass / fail /
 * not-applicable, with a plain-English fix highlighted on failure.
 */
import { useState, useEffect } from 'react';
import { CheckCircle, XCircle, MinusCircle, Loader2, Stethoscope } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
