...
export function StatCard({
  ...
  return (
    <div
      ...
      className={`relative rounded-lg border border-[#6aade0] border-l-4 bg-[#f0f7ff] p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 ${borderClass} ${selectedClass} ${interactiveClass}`}
    >
      {icon && (
