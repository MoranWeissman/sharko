...
export function StatCard({
  ...
  return (
    <div
      ...
      className={`relative rounded-lg border border-[#90c8ee] border-l-4 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 ${borderClass} ${selectedClass} ${interactiveClass}`}
    >
      {icon && (
