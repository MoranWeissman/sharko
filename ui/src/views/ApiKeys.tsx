...
export function ApiKeys({ embedded }: { embedded?: boolean } = {}) {
  ...
  }, [newName, newRole, newExpires, fetchTokens])
      ...
      <div className="overflow-x-auto rounded-xl ring-2 ring-[#6aade0] bg-[#f0f7ff] shadow-sm dark:ring-gray-700 dark:bg-gray-800">
        <table className="w-full text-left text-sm">
          ...
          <tbody className="divide-y divide-[#6aade0] dark:divide-gray-700">
            ...
            {tokens.length === 0 && (
              <tr>
                <td colSpan={7} className="px-6 py-8 text-center text-[#3a6a8a] dark:text-gray-500">
        ...
        <DialogContent>
          ...
          {createdToken ? (
            <div className="space-y-3 py-2">
              <div className="flex items-center gap-2 rounded-md ring-2 ring-[#6aade0] bg-[#d0e8f8] px-3 py-2 dark:ring-gray-700 dark:bg-gray-900">
