...
function DashboardForm({
  ...
  return (
    <form
      ...
      className="rounded-xl ring-2 ring-[#6aade0] bg-[#f0f7ff] p-6 shadow-sm dark:ring-gray-700 dark:bg-gray-900"
    >
        ...
        <div className="min-w-0 flex-1">
          ...
          {effectiveSelected ? (
            <div className="space-y-3">
              {/* Toolbar */}
              <div className="flex items-center justify-between rounded-lg ring-2 ring-[#6aade0] bg-[#f0f7ff] px-4 py-2.5 shadow-sm dark:ring-gray-700 dark:bg-gray-900">
              ...
              {/* Iframe */}
              <div className="overflow-hidden rounded-xl ring-2 ring-[#6aade0] shadow-md dark:ring-gray-700">
                <iframe
