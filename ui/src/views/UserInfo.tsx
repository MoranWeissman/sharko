  ...
  return (
    <div className="space-y-6">
      ...
      <div className="max-w-lg">
        ...
        <form id="password-form" onSubmit={handleUpdatePassword} className="hidden space-y-4 rounded-lg ring-2 ring-[#6aade0] bg-[#d0e8f8] p-6 dark:ring-gray-700 dark:bg-gray-800">
          <div>
