...
export function UserManagement({ embedded }: { embedded?: boolean } = {}) {
  ...
  return (
    <div className="mx-auto max-w-screen-lg space-y-6">
      ...
      {/* Role legend */}
      <div className="flex flex-wrap gap-4 rounded-xl border-2 border-[#6aade0] bg-[#f0f7ff] p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800">
      ...
      {/* Users table */}
      <div className="rounded-xl border-2 border-[#6aade0] bg-[#f0f7ff] shadow-sm dark:border-gray-700 dark:bg-gray-800">
