...
export const H_CONNECTION_SYNCED = 'Connection synced'
export const H_ADDON_LABELS_SYNCED = 'Addon labels synced'
export const H_ADDON_LABELS_OUT_OF_SYNC = 'Addon labels out of sync'
export const H_OUT_OF_SYNC = 'Out of sync'
export const H_OUT_OF_SYNC_APPROVAL = 'Out of sync — approval required'
export const H_OUT_OF_SYNC_CANNOT_RESTORE = 'Out of sync — cannot be restored from Git'
export const H_BLOCKED = 'Blocked'
export const H_VERIFICATION_INCOMPLETE = 'Verification incomplete'
export const H_EKS_PARTIAL = 'Configuration matches; credential content not compared'
export const H_UNKNOWN_CHECK_FAILED = 'Unknown — check failed'
export const H_NOT_CHECKED_YET = 'Not checked yet'

export const Q_SELF_MANAGED = 'Connection data managed outside Sharko'
